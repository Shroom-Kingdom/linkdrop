...
const DiscordSigninButton: FC<{
  ...
  const handleClick = async () => {
    if (account) {
      ...
      window.location.href = `https://discord.com/api/oauth2/authorize?client_id=877802081170391070&redirect_uri=https%3A%2F%2Flinkdrop.shroomkingdom.net%2F&response_type=code&scope=guilds%20identify%20email&state=${state}`;
